...
BSides Augusta::
  ...
  * link:2023-10-07_bsides-augusta/obilodeau_From-DND-to-RDP-Unparalleled-Attacker-Monitoring.pdf[From RDP To D&D: Unparalleled Remote Desktop Monitoring Reveal Attackers' Tradecraft]
...
Human Factor in Cybercrime::
  ...
  * link:2022-11_hfc/Offender_VS_non-offender_Password_HFC2022_Andreanne_Bergeron.pdf[Identifying Offenders Through their Passwords: The Similarity and Difference Between Network of Users]
    by link:{liab}[Andréanne Bergeron]


Americain Society of Criminology::

  * link:2022-11_asc/Offender_VS_non-Offender_ASC2022_Andreanne_Bergeron.pdf[A Password Strategy Taxonomy to Reveal the Difference Between Offender and Non-Offender Strategies]
    by link:{liab}[Andréanne Bergeron]
